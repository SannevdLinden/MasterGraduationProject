...
For a video of the working prototype see: https://youtu.be/_jOJBtkJ5R4 (all visible data is fake and a black rectangle is placed over the synonyms retrieved from the UMLS CUI concepts while using the search function).
