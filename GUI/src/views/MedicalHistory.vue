<template>
  <div class="about">
    ...
    />
    <!-- timeline and list with all clusters of notes-->
...
export default {
  ...
  methods: {
    ...
    noteOpen(id) {
      ...
      console.log(this.prev_opened_clus);
      console.log(cluster_id[0].id);
      if (
    ...
    makeTimeline() {
      ...
      console.log(skip_differences);
      console.log(height_day);
      console.log(height_skip);
      console.log("total_days3");
      ...
      for (let i = 0; i < skip_differences.length; i++) {
        if (skip_differences[i] <= 3) { //no skip difference part
          ...
          let tmp_html =
            ...
            width_indication +
            "px; height:5px; background-color:#bbb;'></div></div><span style='font-style: italic; font-size:small; margin-left: 10px;'>" +
            text_skip_indicator +
            "</span>";
      ...
      for (let i = 0; i < intervals.length; i++) {
        ...
        if (i == 0) {
          ...
          html_code +=
            "<div class='display_flex'><div class='vl5 ' style='height:" +
          ...
          if (skip_differences[i - 1] <= 3 && skip_differences[i - 1] >= 0) {
            ...
            html_code += "</div>"; //first close the flex div from previous bars
            html_code +=
              "<div class='display_flex'><div class='vl-dashed5' style='height:" +
              height_skip +
              "px'></div><div style='position: relative; margin-left: 5px;'><span style='font-style: italic; font-size:small'>" +
              ...
              "</span><br>" +
              html_skip_dif[i - 1] +
              "<br><span style='font-style: italic; font-size:small; position: absolute; bottom:0px'>" +
      ...
      timeline.innerHTML +=
        "<div class='display_flex'><div class='dot'></div><div style='font-style: italic; font-size:small; margin-left:5px;'>" +
      ...
      timeline.innerHTML +=
        "<div class='display_flex' style='margin-top:-8px;'><div class='dot'></div><div style='font-style: italic; font-size:small; margin-left:5px;'>" +
  ...
  mounted() {
    ...
    if (this.data_to_child[5] == true) {
      this.noteOpen(this.data_to_child[6]);
    }
  },
  watch: {
    data_to_child() {
      console.log("app send");
      console.log(this.data_to_child[7]);
      this.search_text = this.data_to_child[2];
      this.search = this.data_to_child[3];
      this.search_result = this.data_to_child[4];
      console.log(this.display_notes);
      console.log("scroll to cluster");
      console.log(this.scroll_to_cluster);
